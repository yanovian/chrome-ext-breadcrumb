...
export const SITE_REPO_PATH = 'chrome-ext-breadcrumb';
...
export const CHROME_STORE_URL =
  'https://chromewebstore.google.com/detail/breadcrumb/medkklaaakhdpgcoaghblbnleeandifi';

export const GITHUB_URL = 'https://github.com/yanovian/chrome-ext-breadcrumb';
...
/** Canonical URL for a site route (e.g. `privacy` → `…/chrome-ext-breadcrumb/privacy`, `fa` + `privacy` → `…/fa/privacy`). */
